...
const generateQuestions = async (req, res) => {
  try {
    const { jobId, jobName, questionType, interviewStyle } = req.body;
    ...
    const result = await interviewService.generateQuestions({ jobId, jobName, questionType, userId, interviewStyle });
    res.json(result);
  } catch (err) {
